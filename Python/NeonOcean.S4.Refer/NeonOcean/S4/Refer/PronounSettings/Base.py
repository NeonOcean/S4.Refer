...
from NeonOcean.S4.Refer import Saving, This
...
class Setting(AbstractSettings.SettingBranchedAbstract):
	...
	def GetNameText (cls) -> localization.LocalizedString:
		return Language.GetLocalizationStringByIdentifier(This.Mod.Namespace + ".Pronoun_Settings.Values." + cls.Key + ".Name", fallbackText = cls.Key)

	@classmethod
	def GetDescriptionText (cls) -> localization.LocalizedString:
		return Language.GetLocalizationStringByIdentifier(This.Mod.Namespace + ".Pronoun_Settings.Values." + cls.Key + ".Description")
