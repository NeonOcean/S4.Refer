...
from NeonOcean.S4.Main import LoadingShared, Reporting
from NeonOcean.S4.Refer import GenderedLanguageHandler, This
...
def _GetIgnoringPersistentDirectories () -> typing.List[str]:
	...
	ignoringDirectories = [
		os.path.normpath(GenderedLanguageHandler.LanguageCacheDirectoryPath),
		os.path.normpath(GenderedLanguageHandler.GenderedLanguageCacheDirectoryPath)
